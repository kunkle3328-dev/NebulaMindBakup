    ...
    <div className={`h-[100dvh] w-full bg-transparent flex flex-col md:flex-row overflow-hidden transition-colors duration-700 ${theme.colors.text}`}>
      ...
      <main className={`flex-1 flex flex-col relative overflow-hidden bg-transparent transition-colors duration-700`}>
        ...
        <div className="flex-1 relative overflow-hidden">
            {/* NOTE: We use style={{ display: ... }} instead of conditional rendering for tabs 
                to ensure the Audio Element in StudioTab is NOT unmounted when switching tabs.
                This enables background audio playback while browsing Sources or Chat. */}
            
            <div 
                className="absolute inset-0 overflow-y-auto overflow-x-hidden p-4 md:p-8 pb-24 md:pb-8"
                style={{ display: activeTab === 'sources' ? 'block' : 'none' }}
            >
            ...
            <div 
                className="absolute inset-0 pb-20 md:pb-0 p-4 md:p-8"
